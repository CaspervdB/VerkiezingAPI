...
exports.xmlValidator = {
    validateElection: (raw) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            var scheme = libxmljs2_xsd_1.default.parseFile(schemesPath + "/election.xsd");
    ...
    validateParty: (raw) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            var scheme = libxmljs2_xsd_1.default.parseFile(schemesPath + "/party.xsd");
            var errors = scheme.validate(raw);
            if (errors)
                return null;
            const obj = yield parse(raw);
    ...
    validateParticipation: (raw) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            var scheme = libxmljs2_xsd_1.default.parseFile(schemesPath + "/participation.xsd");
            var errors = scheme.validate(raw);
            if (errors)
                return null;
            const obj = yield parse(raw);
